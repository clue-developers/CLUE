...
#BIOMD0000000504_curry
print("Example BIOMD0000000504_curry")
pkactMMP13mmp3 = Rational(1, 1)
pkactMMP1mat = Rational(1, 1)
pkactMMP1mmp3 = Rational(1, 1)
pkactMMP3mat = Rational(1, 1)
pkAP1activity = Rational(1, 1)
pkbincFoscJun = Rational(1, 1)
pkbinIL1IL1R = Rational(1, 1)
pkbinIL1IL1Ra = Rational(1, 1)
pkbinIRAK2 = Rational(1, 1)
pkbinOSMOSMR = Rational(1, 1)
pkbinOSMOSMRa = Rational(1, 1)
pkbinSOCS3OSMR = Rational(1, 1)
pkbinSP1TIMP1DNA = Rational(1, 1)
pkbinTRAF6 = Rational(1, 1)
pkcyt2nucSTAT3 = Rational(1, 1)
pkdedimercJun = Rational(1, 1)
pkdegADAMTS4 = Rational(1, 1)
pkdegADAMTS4mRNA = Rational(1, 1)
pkdegAggrecan = Rational(1, 1)
pkdegcFos = Rational(1, 1)
pkdegcFosmRNA = Rational(1, 1)
pkdegcJun = Rational(1, 1)
pkdegcJunmRNA = Rational(1, 1)
pkdegCollagen2mmp1 = Rational(1, 1)
pkdegCollagen2mmp13 = Rational(1, 1)
pkdegDUSP16 = Rational(1, 1)
pkdegIL1 = Rational(1, 1)
pkdegMatriptase = Rational(1, 1)
pkdegMKP1 = Rational(1, 1)
pkdegMMP1 = Rational(1, 1)
pkdegMMP13 = Rational(1, 1)
pkdegMMP13mRNA = Rational(1, 1)
pkdegMMP1mRNA = Rational(1, 1)
pkdegMMP3 = Rational(1, 1)
pkdegMMP3mRNA = Rational(1, 1)
pkdegOSM = Rational(1, 1)
pkdegPP4 = Rational(1, 1)
pkdegPTPRT = Rational(1, 1)
pkdegSOCS3 = Rational(1, 1)
pkdegSOCS3mRNA = Rational(1, 1)
pkdegSP1 = Rational(1, 1)
pkdegTIMP1 = Rational(1, 1)
pkdegTIMP1mRNA = Rational(1, 1)
pkdegTIMP3 = Rational(1, 1)
pkdegTIMP3mRNA = Rational(1, 1)
pkdephoscFos = Rational(1, 1)
pkdephoscFosDUSP16 = Rational(1, 1)
pkdephoscJun = Rational(1, 1)
pkdephosJAK1 = Rational(1, 1)
pkdephosJAK1PTPRT = Rational(1, 1)
pkdephosJNK = Rational(1, 1)
pkdephosJNKDUSP16 = Rational(1, 1)
pkdephosp38 = Rational(1, 1)
pkdephosp38MKP1 = Rational(1, 1)
pkdephosSTAT3 = Rational(1, 1)
pkdephosSTAT3nuc = Rational(1, 1)
pkdephosSTAT3nucPTPRT = Rational(1, 1)
pkdephosSTAT3PTPRT = Rational(1, 1)
pkdimercJun = Rational(1, 1)
pkinhibADAMTS4TIMP1 = Rational(1, 1)
pkinhibADAMTS4TIMP3 = Rational(1, 1)
pkinhibMMP13TIMP1 = Rational(1, 1)
pkinhibMMP13TIMP3 = Rational(1, 1)
pkinhibMMP1TIMP1 = Rational(1, 1)
pkinhibMMP1TIMP3 = Rational(1, 1)
pkinhibMMP3TIMP1 = Rational(1, 1)
pkinhibMMP3TIMP3 = Rational(1, 1)
pkinhibTRAF6 = Rational(1, 1)
pknuc2cytSTAT3 = Rational(1, 1)
pkphoscFos = Rational(1, 1)
pkphoscJun = Rational(1, 1)
pkphosJAK1 = Rational(1, 1)
pkphosJNK = Rational(1, 1)
pkphosp38 = Rational(1, 1)
pkphosSTAT3 = Rational(1, 1)
pkrelADAMTS4TIMP1 = Rational(1, 1)
pkrelADAMTS4TIMP3 = Rational(1, 1)
pkrelcFoscJun = Rational(1, 1)
pkrelIL1IL1R = Rational(1, 1)
pkrelIL1IL1Ra = Rational(1, 1)
pkrelIRAK2 = Rational(1, 1)
pkrelMMP1 = Rational(1, 1)
pkrelMMP13 = Rational(1, 1)
pkrelMMP13TIMP3 = Rational(1, 1)
pkrelMMP1TIMP3 = Rational(1, 1)
pkrelMMP3 = Rational(1, 1)
pkrelMMP3TIMP3 = Rational(1, 1)
pkrelOSMOSMR = Rational(1, 1)
pkrelOSMOSMRa = Rational(1, 1)
pkrelSOCS3OSMR = Rational(1, 1)
pkrelSP1TIMP1DNA = Rational(1, 1)
pkrelTRAF6 = Rational(1, 1)
pkrelTRAF6PP4 = Rational(1, 1)
pksynADAMTS4 = Rational(1, 1)
pksynADAMTS4mRNA = Rational(1, 1)
pksynADAMTS4mRNAcJun = Rational(1, 1)
pksynbasalcJunmRNA = Rational(1, 1)
pksynbasalTIMP1mRNA = Rational(1, 1)
pksynbasalTIMP3mRNA = Rational(1, 1)
pksyncFos = Rational(1, 1)
pksyncFosmRNA = Rational(1, 1)
pksyncFosmRNAStat3 = Rational(1, 1)
pksyncJun = Rational(1, 1)
pksyncJunmRNA = Rational(1, 1)
pksyncJunmRNAcJun = Rational(1, 1)
pksynDUSP16 = Rational(1, 1)
pksynDUSP16cJun = Rational(1, 1)
pksynMatriptase = Rational(1, 1)
pksynMKP1 = Rational(1, 1)
pksynMKP1cJun = Rational(1, 1)
pksynMMP1 = Rational(1, 1)
pksynMMP13 = Rational(1, 1)
pksynMMP13mRNA = Rational(1, 1)
pksynMMP13mRNAcJun = Rational(1, 1)
pksynMMP1mRNA = Rational(1, 1)
pksynMMP1mRNAcJun = Rational(1, 1)
pksynMMP3 = Rational(1, 1)
pksynMMP3mRNA = Rational(1, 1)
pksynMMP3mRNAcJun = Rational(1, 1)
pksynPP4 = Rational(1, 1)
pksynPP4cJun = Rational(1, 1)
pksynPTPRT = Rational(1, 1)
pksynSOCS3 = Rational(1, 1)
pksynSOCS3mRNA = Rational(1, 1)
pksynSP1 = Rational(1, 1)
pksynTIMP1 = Rational(1, 1)
pksynTIMP1mRNA = Rational(1, 1)
pksynTIMP1mRNAStat3 = Rational(1, 1)
pksynTIMP3 = Rational(1, 1)
pksynTIMP3mRNA = Rational(1, 1)
pksynTIMP3mRNAStat3 = Rational(1, 1)
ptempDimer = Rational(1, 1)
...
print("Total for BIOMD0000000504_curry, preserving cFos_P, cJun_P, is " + str(len(result["polynomials"])))

#Partition preserving MMP1_mRNA, MMP13_mRNA, TIMP1_mRNA
result = lumper.do_lumping(polys, [x16,x18,x30])
print("Total for BIOMD0000000504_curry is " + str(len(result["polynomials"])))
