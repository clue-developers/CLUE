...
print("Total for e3_curry S0 is " + str(len(result[0])))

#{S1}
result = lumper.do_lumping(polys, [x2])
print("Total for e3_curry S1 is " + str(len(result[0])))
...
print("Total for e3_curry fr the SUM of Block 3 is " + str(len(result[0])))
...
print("Total for e3_curry for the SUM of block 4 is " + str(len(result[0])))
