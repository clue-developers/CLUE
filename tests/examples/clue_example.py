...
def print_help():
    print(
        ...
        "--------------------------------------------------------------------------------------------------------------------------\n"
        "\tpython3 clue_example.py add [-r ()]* [-m ()]* [-o ()] [-O ()] [-s] <<folder>>*\n"
        ...
        "--------------------------------------------------------------------------------------------------------------------------\n"
        "\tpython3 clue_example.py list [-r|-p|-u] [-of ()]* [-wf ()]* [-n ()]* [-wn ()]* [-e|-ne] [-a]\n"
