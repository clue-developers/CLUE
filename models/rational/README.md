...
whose dynamics are rational functions. The name of each model is either given by the theme of the model or the name in the database.
...
* BIOMD0000000023: [Analysis of sucrose accumulation in the sugar cane culm on the basis of in vitro kinetic data](https://doi.org/10.1042/bj3580437)
